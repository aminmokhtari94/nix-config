...
in
{
  config = mkIf (cfg.name == "inspored") {
    ...
    # '';
    #
    # xdg.configFile."nvim/plugin/statusline.lua".source =
    #   ./galaxy-line-inspired.lua;
    xdg.configFile."tmux/statusline.tmux".source = ./tmux;
    # xdg.configFile."kitty/themes/theme.conf".source =
    #   ../kitty/themes/inspired-github.conf;
    #
    # programs.yazi.theme = {
    #   manager = {
    #     hovered = { bg = "#F4F4F4"; };
    ...
    #     "--reverse"
    #     "--ansi"
    #     "--color bg+:#FFFFFF,border:#969896,fg:-1,fg+:-1,header:#0086B3,hl:#A71D5D,hl+:#A71D5D,info:#0086B3,pointer:#D4BFFF,prompt:#A71D5D,spinner:#795DA3"
    #   ];
    # };
    #
    ...
    #   };
    #
    #   git_branch = { format = "[  $branch ](fg:#A71D5D)"; };
    #
    #   git_status = { style = "bold #795DA3"; };
    #
    #   jobs = { symbol = "[ 󰠜 ](bg:#E0E0E0 fg:#000000)"; };
    #
    #   status = {
    ...
    #   options = {
    #     light = true;
    #     decorations = { syntax-theme = "GitHub"; };
